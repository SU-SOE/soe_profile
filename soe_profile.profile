 ...
 */
function soe_profile_menu_links_discovered_alter(&$links) {
 ...
 */
function soe_profile_preprocess_block__help(&$variables) {
 ...
 */
function soe_profile_help_section_info_alter(array &$info) {
 ...
 */
function soe_profile_menu_link_content_presave(MenuLinkContent $entity) {
 ...
 * Implements hook_preprocess_HOOK().
 */
function soe_profile_preprocess_input__submit__paragraph_action(&$variables) {
 ...
 */
function soe_profile_field_widget_options_select_form_alter(&$element, FormStateInterface $form_state, $context) {
 ...
 */
function soe_profile_preprocess_toolbar(&$variables) {
 ...
 */
function soe_profile_contextual_links_alter(array &$links, $group, array $route_parameters) {
  if ($group == 'paragraph') {
 ...
 */
function soe_profile_node_access(NodeInterface $node, $op, AccountInterface $account) {
  if ($op == 'delete') {
 ...
 */
function soe_profile_form_menu_edit_form_alter(array &$form, FormStateInterface $form_state) {
 ...
 * Implements hook_form_FORM_ID_alter().
 */
function soe_profile_form_config_pages_stanford_basic_site_settings_form_alter(array &$form, FormStateInterface $form_state) {
  $form['#validate'][] = 'soe_profile_config_pages_stanford_basic_site_settings_form_validate';
}
 ...
 */
function soe_profile_config_pages_stanford_basic_site_settings_form_validate(array $form, FormStateInterface $form_state) {
 ...
 */
function soe_profile_config_pages_presave(ConfigPagesInterface $entity) {
